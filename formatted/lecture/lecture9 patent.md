...
- patent belongs to the **inventor**: s.9E
...
- **4 conditions:**  
  1. susceptible of industrial application  
  2. new ("novel" or "not anticipated")  
  3. involves an inventive step ("not obvious")  
  4. not excluded under ss.9A(2)-(6)
...
- can be used in any kind of industry, including agriculture, i.e. invention must have a useful or practical purpose

> **NB.** Certain matters deemed not susceptible of industrial application, e.g. medical treatment of human or animal body: s.9A(4).
...
> **NB.** Non-prejudicial disclosure with regard to novelty: s.11A.

---

## Inventiveness: s.9C

- **"inventive"** if having regard to the state of the art, the invention is **"not obvious to a person skilled in the art"** (i.e. someone who knows the state of the art)
...
> **NB.** True meaning of **"as such"** not easy to ascertain.  
> **NB.** UK's and EPO's interpretation of "as such" has changed over the years!  
> **NB.** See exclusions under ss.9A(4)-(6) for subject matters other than computer programs.

---

## UK's Early Interpretation of "As Such"

- a computer program **by itself** (i.e. "as such") is not patentable.
...
- the normal interaction between a program and the hardware when the program is run cannot constitute the requisite technical effect

- there must be **further effects** deriving from running the program which have a technical character or which solve a technical problem
...
> **NB.** The above principles as regards patenting software have extended to all excluded subject matters in s.9A(2).  
> Cf. Latest 4-step test in *Aerotel v Telco Holdings* [2006] EWCA Civ 1371:  
> 1. properly construe the claim  
> 2. identify the actual contribution  
> 3. ask whether it falls solely within the excluded subject matter  
> 4. check whether the actual or alleged contribution is actually technical in nature

> **NB.** The *Aerotel* test is essentially a reformulation of the earlier tests on exclusion stemming from *Merrill Lynch* and *IBM*. The test is now applied to all subject matters in s.9A(2).

---

## PRC's Position

- computer programs by themselves are excluded as **"rules and methods for mental activities"** which are not patentable: PRC Patent Law, Art 25(2)

- **BUT** if a program is combined with hardware to form an **"integrated technical solution"** that solves a technical problem and produces technical effect, the combination is patentable
