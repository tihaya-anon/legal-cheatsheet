...
#table(
  ...
  [s.2(1)], [作者/权利人/被告], [定义版权、作品等基础概念，是是否进入版权法分析的入口条文。], [本条主要为定义条；后续责任取决于受限制行为条文。],
  ...
  [s.117(1)(e)], [商业经营者/公司负责人], [该子段用于界定特定“为业务目的而处理侵权复制品”的刑事化行为类型，考试上需与 s.31 的民事“dealing”并列写。], [一旦满足商业目的与主观要件，即进入刑事路径（罚款与监禁按该罪项上限）。],
  ...
  [s.118(8B)], [跨境相关行为人/平台经营者], [把“在业务过程中向公众传播作品并以营利或显著损害版权人利益”为核心的网络传播行为纳入刑事责任。], [常用于串流/网站传播案件；与 s.28A 民事责任并行。],
...
#table(
  ...
  [s.18(5)], [DAR 请求人], [任何人为促使数据使用者依从查阅请求而故意提供虚假或误导性资料，可构成独立罪行。], [属于程序滥用型刑责；可被检控并影响后续请求可信度。],
  ...
  [s.20(2)(b)], [数据使用者], [若可在不不当披露第三方资料下提供请求人资料，应采取该替代方案。], [未尽遮蔽义务而直接拒绝，易被认定程序不合规。],
  ...
  [s.20(3)(d)], [数据使用者], [在技术或组织上确有不可行部分时，可就可行部分先行依从。], [强调比例原则与可行性证明责任。],
  [s.20(3)(ea)], [数据使用者], [对特定敏感或受限制场景设置额外处理条件，要求在拒绝与部分依从间做更精细化判断。], [未逐项说明为何触发该条件，拒绝决定易被推翻。],
  ...
  [s.35C], [数据使用者], [在进行直销前必须先完成法定告知，并取得资料当事人的同意或不反对。], [违反可构成犯罪；课件注明最高可达 \$500,000 + 3年监禁。],
  ...
  [s.35K], [数据使用者], [涉及利益交换时更严格同意机制。], [违反可构成犯罪：为得益 \$1,000,000 + 5年；非为得益 \$500,000 + 3年。],
  ...
  [s.38], [私隐专员/被调查者], [专员可要求提交资料、作出解释及配合调查步骤。], [拒绝、拖延或虚假回应会独立增加法律风险。],
  ...
  [s.64(3B)], [任何人], [就特定起底行为在主观状态与伤害后果层面提供独立定罪节点，低于最重罪阶但仍属刑事罪。], [课件注明可处第6级罚款 + 2年监禁。],
  ...
  [s.64(6)], [法院/当事人], [解释“相关同意”“指明伤害”等关键术语，直接影响入罪边界。], [术语解释错误会导致整题结论偏差。],
  ...
  [s.56], [医疗机构/专业人员], [在医疗或健康保护场景下可有限放宽部分义务，但前提是为保护当事人或公众健康所必需。], [超出医疗必要范围的传播仍可能违法。],
  [s.57], [研究机构/统计机构], [研究统计豁免通常要求用途为研究/统计而非个体决策，并采取去识别或等效保护措施。], [若回溯识别个人并作针对性决策，豁免大幅减弱。],
  [s.58], [执法机构], [防止/侦查罪案等豁免。], [限执法目的。],
  [s.59], [执法/监管机构], [为维护公共安全、监管执法或防止严重不当行为所必需的资料使用可获有限豁免。], [必须证明必要性与比例性，不能泛化为长期留存或任意共享。],
...
#table(
  ...
  [s.88(3)], [专利权人/被告], [限定授权后追溯救济的范围与前提，防止把临时保护无限扩张。], [权利人需证明被告行为与最终授权权利要求实质对应。],
)
